...
static int graphics_init(SDL_Window **window) {
  ...
  // #ifdef DEBUG
  graphics_state.window = *window = SDL_CreateWindow("cmantic", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_OPENGL | SDL_WINDOW_RESIZABLE | SDL_WINDOW_BORDERLESS);
  // #else
