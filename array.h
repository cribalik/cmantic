...
#define array_insert(a, i, x) (array_push(a, x), memmove((a)+(i)+1, (a)+(i), array_len(a) - (i) - 1), (a)[i] = (x))
...
#define array_reserve(a, n) ((n) > array_cap(a) ? (a)=array__grow(a, sizeof(*(a)), (n) - array_cap(a)) : 0)
